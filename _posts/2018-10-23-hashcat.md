...
# HashCat安装及测试
HashCat的GitHub[下载地址](https://github.com/hashcat/hashcat)
...
Guess.Queue.Base.:
Guess.Queue.Mod..:
Speed.Dev.#2.....: 显卡1的速度(1386.0MH/s 约等于每秒13亿次运算)
Speed.Dev.#3.....: 显卡2...
Speed.Dev.#*.....: 总速度
Recovered........: 
...
# HashCat破解实例
以一个NTLM哈希为例,密码形式前6位为小写字母,后四位为数字,暴力破解如下
```
root@ubun:/home/ubuntu/hashcat-5.1.0# echo b868a9476a6ad3f142b76a99d614a640 > 1.txt
root@ubun:/home/ubuntu/hashcat-5.1.0# ./hashcat64.bin --force -a 3 -m 1000 1.txt ?l?l?l?l?l?l?d?d?d?d
root@ubun:/home/ubuntu/hashcat-5.1.0# ./hashcat64.bin --force -a 3 -m 1000 1.txt ?l?l?l?l?l?l?d?d?d?d --show
b868a9476a6ad3f142b76a99d614a640:puszek2018
```
...
| 攻击模式  | Hash种类 | 示例命令                                                              |
|-------|--------|-------------------------------------------------------------------|
| 字典    | PHPASS | hashcat -a 0 -m 400 example400.hash example.dict                  |
